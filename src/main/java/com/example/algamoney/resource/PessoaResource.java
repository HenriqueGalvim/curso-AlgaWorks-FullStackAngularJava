...
public class PessoaResource {
	...
	public ResponseEntity<Pessoa> criar(@Valid @RequestBody Pessoa pessoa, HttpServletResponse response){
		...
		publisher.publishEvent(new ResourceCreateEvent(this, response, pessoaNova.getCodigo()));
	...
	// No content retorna 204, o conteudo q vc fez deu certo e eu não tenho nada pra ti retornar
